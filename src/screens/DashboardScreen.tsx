...
import bloomFlower from "@/assets/bloom-flower-accent.png";
  ...
  return (
    <div className="min-h-screen pb-24 px-5 pt-14 relative overflow-hidden">
      <img
        src={bloomFlower}
        alt=""
        className="absolute -top-6 -left-10 w-32 opacity-20 pointer-events-none select-none rotate-12"
        aria-hidden="true"
      />

      <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }}>
        <div className="label-caps text-bloom-pink mb-1">Dashboard</div>
        <h1 className="text-xl font-semibold tracking-tight font-display">Your Footprint</h1>
      </motion.div>
      ...
      <motion.div
        ...
        className="bg-card rounded-2xl shadow-card bloom-border p-5 mt-5 mb-4"
      >
        <div className="label-caps text-muted-foreground mb-1">This Week Total</div>
        <div className="flex items-baseline gap-2">
          <span className="text-5xl font-semibold tracking-tighter tabular font-display">{totalWeek.toFixed(1)}</span>
      ...
      >
        ...
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-xl bloom-gradient flex items-center justify-center">
      ...
      >
        <div className="bg-card rounded-2xl shadow-card bloom-border p-4">
          ...
          <div className="text-2xl font-semibold tracking-tighter tabular font-display">47</div>
          <div className="text-xs text-muted-foreground">This month</div>
        </div>
        <div className="bg-card rounded-2xl shadow-card bloom-border p-4">
          <div className="label-caps text-muted-foreground mb-1">Best Day</div>
          <div className="text-2xl font-semibold tracking-tighter tabular font-display">0.4</div>
